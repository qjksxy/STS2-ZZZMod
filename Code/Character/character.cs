...
namespace ZZZMod.Code.Character;

[RegisterCharacter]
public class ZZZCharacter : ModCharacterTemplate<ZZZCardPool, ZZZRelicPool, ZZZPotionPool>
{
    // 角色名称颜色
    ...
    public override CharacterAssetProfile AssetProfile => CharacterAssetProfiles.Merge(
        ...
        new(
            Scenes: new(
                // 人物模型tscn路径。
                VisualsPath: "res://ZZZMod/scenes/test_character.tscn",
                // 能量表盘tscn路径。
                EnergyCounterPath: "res://ZZZMod/scenes/test_energy_counter.tscn",
                // 商店人物场景。
                MerchantAnimPath: "res://ZZZMod/scenes/test_character_merchant.tscn",
                // 篝火休息场景。
                RestSiteAnimPath: "res://ZZZMod/scenes/test_character_rest_site.tscn"
            ),
            Ui: new(
                // 人物头像路径。
                ...
                // 人物选择图标。
                CharacterSelectIconPath: "res://ZZZMod/images/char_select_test.png",
                // 人物选择图标-锁定状态。
                CharacterSelectLockedIconPath: "res://ZZZMod/images/char_select_test_locked.png"
                // 人物选择过渡动画。
